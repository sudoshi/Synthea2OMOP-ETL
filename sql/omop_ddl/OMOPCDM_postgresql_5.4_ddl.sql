...
CREATE TABLE omop.device_exposure (
			...
			unique_device_id varchar(2000) NULL,
			production_id varchar(2000) NULL,
			quantity integer NULL,
			provider_id integer NULL,
			visit_occurrence_id integer NULL,
			visit_detail_id integer NULL,
...
CREATE TABLE omop.cdm_source (
			...
			cdm_holder varchar(2000) NOT NULL,
...
CREATE TABLE omop.vocabulary (
			...
			vocabulary_reference varchar(2000) NULL,
...
CREATE TABLE omop.cohort_definition (
			cohort_definition_id integer NOT NULL,
			cohort_definition_name varchar(2000) NOT NULL,
